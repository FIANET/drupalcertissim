 ...
 */
function generateRandomRefIdCertissim($i = 10)
{
 ...
 * @return bool 
 */
function isXMLstringCertissim($string, $debug = false)
{
	if ($debug)
 ...
 * @return bool 
 */
function isTypeCertissim($type, $object)
{
 ...
 * @return bool 
 */
function isXMLElementCertissim($input)
{
 ...
 * @return boolean 
 */
function isFormFieldCertissim($input)
{
 ...
 * @return boolean 
 */
function isFormCertissim($input)
{
 ...
 * @return bool 
 */
function isSimpleXMLElementCertissim($input)
{
 ...
 * @param string $name 
 */
function normalizeNameCertissim($name)
{
 ...
 */
function insertLogCertissim($func, $msg)
{
	CertissimLogger::insertLogCertissim($func, $msg);
}
/*
