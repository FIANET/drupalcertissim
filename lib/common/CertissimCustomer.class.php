 ...
 */
class CertissimCustomer extends CertissimXMLElement {
  ...
  /**
   * creates an object CertissimXMLElement reprensenting <siteconso>, adds it to the current object and sets its children, then returns it
   * 
