...
class CertissimControl extends CertissimDOMDocument
{

	private $fianetmodule = 'api_drupalcommerce';
	private $fianetmoduleversion = '4.4';

	public function __construct()
	{
		@parent::__construct('1.0', 'UTF-8');
		@$this->root = $this->appendChild(new CertissimXMLElement('control'));
		$this->root->setAttribute('fianetmodule', $this->fianetmodule);
		$this->root->setAttribute('certissimmodule', '1.0.1');
		$this->root->setAttribute('version', $this->fianetmoduleversion);
	}

	/**
	 * creates an object CertissimCustomer representing the element <utilisateur> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type
	...
	{
		$customer = $this->root->appendChild(new CertissimCustomer());
		if ($type != '')
		{
			$customer->addAttribute('type', $type);
			$customer->addAttribute('qualite', CertissimCustomer::TYPE_PARTICULIER);
		}
	...
	/**
	 * creates an object CertissimCustomer representing the element <utilisateur type='facturation'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type
	 * @param string $civility
	 * @param string $lastname
	...
	/**
	 * creates an object CertissimCustomer representing the element <utilisateur type='livraison'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type
	 * @param string $civility
	 * @param string $lastname
	...
	/**
	 * creates an object CertissimCustomer representing the element <adresse> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	...
	/**
	 * creates an object CertissimCustomer representing the element <adresse type='facturation'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type has to be 'livraison' or 'facturation'
	 * @param string $street main street of the address
	 * @param string $zipcode
	...
	/**
	 * creates an object CertissimCustomer representing the element <adresse type='livraison'> then adds id as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 * @param string $type has to be 'livraison' or 'facturation'
	 * @param string $street main street of the address
	 * @param string $zipcode
	...
	/**
	 * creates an object CertissimOrderDetails representing the element <infocommande> then adds it as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	 ...
	 * @return CertissimOrderDetails
	 */
	public function createOrderDetails($refid, $siteid, $amount, $currency, $ip, $timestamp, $lang = null)
	{
		$order_details = $this->root->appendChild(new CertissimOrderDetails());
	...
	/**
	 * creates a CertissimOrderProducts object representing element <produits>, adds it to the current element, then returns it
	 * 
	 * @return CertissimOrderProducts
	 */
	public function createOrderProducts()
	{
		$product_list = $this->addChild(new CertissimOrderProducts());
		return $product_list;
	}

	/**
	 * creates an object CertissimXMLElement representing the element <paiement> then adds it as a child of root, then adds the sub-children given in param, then returns the child
	 * 
	...
	{
		$payment = $this->root->appendChild(new CertissimXMLElement('paiement'));
