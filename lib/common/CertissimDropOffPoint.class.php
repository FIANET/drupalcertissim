 ...
 */
class CertissimDropOffPoint extends CertissimXMLElement {
  ...
  /**
   * creates an object CertissimXMLElement representing the element <adresse> and adds it as a child of the current element, then returns it
   * 
