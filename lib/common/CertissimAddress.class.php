 ...
 */
class CertissimAddress extends CertissimXMLElement {
  ...
  /**
   * creates an object CertissimXMLElement representing the element <appartement>, child of <adresse>, adds it to the current object then returns it
   * 
